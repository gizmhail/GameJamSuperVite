...
* Phaser quickstart book
https://leanpub.com/html5shootemupinanafternoon/read
* Pascal's tutorial
https://github.com/PascalLeMerrer/phaser-games
...
Needed format: Orthogonal / CSV / .json files
* Game development resources
https://game-development.zeef.com/david.arcila
* Shoebox (Spritesheet manipulation)
http://renderhjs.net/shoebox/
* Physic Editor (Useful to easily create P2 polygon body - 20€, free demo)
